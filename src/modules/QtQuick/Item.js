...
QmlWeb.registerQmlType({
  ...
  properties: {
    ...
    right: { type: "real", initialValue: 0 },
    top: { type: "real", initialValue: 0 },
    bottom: { type: "real", initialValue: 0 },
    horizontalCenter: { type: "real", initialValue: 0 },
    verticalCenter: { type: "real", initialValue: 0 },
    rotation: { type: "real", initialValue: 0 },
