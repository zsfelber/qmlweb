 ...
 */
  ...
  static fakectx(obj) {
    return {$ownerObject:obj, $externalContext:{}, $pageContext:{}, $self:{}};
  }
  ...
  namespace() {
    ...
    if (this.flags & QmlWeb.QMLBindingFlags.ContextNullable) {
      if (this.flags & QmlWeb.QMLBindingFlags.Alias) {
        vvith = "var $$c=this.$context?this.$context:QMLBinding.fakectx(this),$$o=$$c.$ownerObject; with(QmlWeb) with($$c.$externalContext.__proto__) with($$c.$pageContext) with($$o.$noalias) with($$c.$self)";
      } else {
        vvith = "var $$c=this.$context?this.$context:QMLBinding.fakectx(this),$$o=$$c.$ownerObject; with(QmlWeb) with($$c.$externalContext.__proto__) with($$c.$pageContext) with($$o) with($$c.$self)";
      }
    } else {
      ...
      if (this.flags & QmlWeb.QMLBindingFlags.Alias) {
        vvith = "var $$c=this.$context,$$o=$$c.$ownerObject; with(QmlWeb) with($$c.$externalContext.__proto__) with($$c.$pageContext) with($$o.$noalias) with($$c.$self)";
      } else {
        vvith = "var $$c=this.$context,$$o=$$c.$ownerObject; with(QmlWeb) with($$c.$externalContext.__proto__) with($$c.$pageContext) with($$o) with($$c.$self)";
      }
    }
    return vvith;
  }
